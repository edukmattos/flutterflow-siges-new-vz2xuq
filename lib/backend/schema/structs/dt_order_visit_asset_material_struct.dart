...
class DtOrderVisitAssetMaterialStruct extends BaseStruct {
  DtOrderVisitAssetMaterialStruct({
    int? id,
    int? ovId,
    int? ovaId,
    int? assetId,
  ...
  static DtOrderVisitAssetMaterialStruct fromMap(Map<String, dynamic> data) =>
      DtOrderVisitAssetMaterialStruct(
  ...
  static DtOrderVisitAssetMaterialStruct? maybeFromMap(dynamic data) => data
          is Map
      ? DtOrderVisitAssetMaterialStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static DtOrderVisitAssetMaterialStruct fromSerializableMap(
  ...
  @override
  String toString() => 'DtOrderVisitAssetMaterialStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is DtOrderVisitAssetMaterialStruct &&
        id == other.id &&
        ovId == other.ovId &&
        ovaId == other.ovaId &&
...
DtOrderVisitAssetMaterialStruct createDtOrderVisitAssetMaterialStruct({
  int? id,
  int? ovId,
  int? ovaId,
  int? assetId,
