...
class DtAssetTagSubStruct extends BaseStruct {
  DtAssetTagSubStruct({
    int? id,
    int? companyId,
    String? code,
  ...
  static DtAssetTagSubStruct fromMap(Map<String, dynamic> data) =>
      DtAssetTagSubStruct(
  ...
  static DtAssetTagSubStruct? maybeFromMap(dynamic data) => data is Map
      ? DtAssetTagSubStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static DtAssetTagSubStruct fromSerializableMap(Map<String, dynamic> data) =>
      DtAssetTagSubStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'DtAssetTagSubStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is DtAssetTagSubStruct &&
        id == other.id &&
...
DtAssetTagSubStruct createDtAssetTagSubStruct({
  int? id,
  int? companyId,
  String? code,
  String? description,
