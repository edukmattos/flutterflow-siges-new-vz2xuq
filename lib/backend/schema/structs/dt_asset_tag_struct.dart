...
class DtAssetTagStruct extends BaseStruct {
  DtAssetTagStruct({
    int? id,
    int? companyId,
    String? code,
  ...
  static DtAssetTagStruct fromMap(Map<String, dynamic> data) =>
      DtAssetTagStruct(
  ...
  static DtAssetTagStruct? maybeFromMap(dynamic data) => data is Map
      ? DtAssetTagStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static DtAssetTagStruct fromSerializableMap(Map<String, dynamic> data) =>
      DtAssetTagStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'DtAssetTagStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is DtAssetTagStruct &&
        id == other.id &&
...
DtAssetTagStruct createDtAssetTagStruct({
  int? id,
  int? companyId,
  String? code,
  String? description,
