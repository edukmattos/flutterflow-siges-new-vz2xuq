...
class DtOrderTypeStruct extends BaseStruct {
  DtOrderTypeStruct({
    int? id,
    int? departmentId,
    String? code,
  ...
  static DtOrderTypeStruct fromMap(Map<String, dynamic> data) =>
      DtOrderTypeStruct(
  ...
  static DtOrderTypeStruct? maybeFromMap(dynamic data) => data is Map
      ? DtOrderTypeStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static DtOrderTypeStruct fromSerializableMap(Map<String, dynamic> data) =>
      DtOrderTypeStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'DtOrderTypeStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is DtOrderTypeStruct &&
        id == other.id &&
...
DtOrderTypeStruct createDtOrderTypeStruct({
  int? id,
  int? departmentId,
  String? code,
  String? description,
