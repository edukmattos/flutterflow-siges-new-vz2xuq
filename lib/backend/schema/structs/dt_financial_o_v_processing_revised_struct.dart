...
class DtFinancialOVProcessingRevisedStruct extends BaseStruct {
  ...
  static DtFinancialOVProcessingRevisedStruct fromMap(
  ...
  static DtFinancialOVProcessingRevisedStruct? maybeFromMap(dynamic data) =>
      data is Map
          ? DtFinancialOVProcessingRevisedStruct.fromMap(
  ...
  static DtFinancialOVProcessingRevisedStruct fromSerializableMap(
          Map<String, dynamic> data) =>
      DtFinancialOVProcessingRevisedStruct(
  ...
  @override
  String toString() => 'DtFinancialOVProcessingRevisedStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is DtFinancialOVProcessingRevisedStruct &&
...
DtFinancialOVProcessingRevisedStruct
    createDtFinancialOVProcessingRevisedStruct({
  double? servicesValue,
  double? materialsValue,
  double? vehiclesValue,
  double? totalValue,
