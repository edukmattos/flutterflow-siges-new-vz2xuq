...
class DtFinancialOVProcessingReportedStruct extends BaseStruct {
  ...
  static DtFinancialOVProcessingReportedStruct fromMap(
  ...
  static DtFinancialOVProcessingReportedStruct? maybeFromMap(dynamic data) =>
      data is Map
          ? DtFinancialOVProcessingReportedStruct.fromMap(
  ...
  static DtFinancialOVProcessingReportedStruct fromSerializableMap(
          Map<String, dynamic> data) =>
      DtFinancialOVProcessingReportedStruct(
  ...
  @override
  String toString() => 'DtFinancialOVProcessingReportedStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is DtFinancialOVProcessingReportedStruct &&
...
DtFinancialOVProcessingReportedStruct
    createDtFinancialOVProcessingReportedStruct({
  double? servicesValue,
  double? materialsValue,
  double? vehiclesValue,
  double? totalValue,
