...
class DtOrderPlanStruct extends BaseStruct {
  DtOrderPlanStruct({
    int? id,
    int? departmentId,
    String? code,
  ...
  static DtOrderPlanStruct fromMap(Map<String, dynamic> data) =>
      DtOrderPlanStruct(
  ...
  static DtOrderPlanStruct? maybeFromMap(dynamic data) => data is Map
      ? DtOrderPlanStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static DtOrderPlanStruct fromSerializableMap(Map<String, dynamic> data) =>
      DtOrderPlanStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'DtOrderPlanStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is DtOrderPlanStruct &&
        id == other.id &&
...
DtOrderPlanStruct createDtOrderPlanStruct({
  int? id,
  int? departmentId,
  String? code,
  String? description,
