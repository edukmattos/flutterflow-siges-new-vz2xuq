...
class DtFinancialOVProcessingDraftStruct extends BaseStruct {
  ...
  static DtFinancialOVProcessingDraftStruct fromMap(
  ...
  static DtFinancialOVProcessingDraftStruct? maybeFromMap(dynamic data) => data
          is Map
      ? DtFinancialOVProcessingDraftStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static DtFinancialOVProcessingDraftStruct fromSerializableMap(
          Map<String, dynamic> data) =>
      DtFinancialOVProcessingDraftStruct(
  ...
  @override
  String toString() => 'DtFinancialOVProcessingDraftStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is DtFinancialOVProcessingDraftStruct &&
...
DtFinancialOVProcessingDraftStruct createDtFinancialOVProcessingDraftStruct({
  double? servicesValue,
  double? materialsValue,
  double? vehiclesValue,
  double? totalValue,
