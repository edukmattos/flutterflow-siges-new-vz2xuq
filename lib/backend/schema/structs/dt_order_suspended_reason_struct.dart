...
class DtOrderSuspendedReasonStruct extends BaseStruct {
  DtOrderSuspendedReasonStruct({
    int? id,
    int? departmentId,
    String? description,
    bool? isAvailable,
  ...
  static DtOrderSuspendedReasonStruct fromMap(Map<String, dynamic> data) =>
      DtOrderSuspendedReasonStruct(
  ...
  static DtOrderSuspendedReasonStruct? maybeFromMap(dynamic data) => data is Map
      ? DtOrderSuspendedReasonStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static DtOrderSuspendedReasonStruct fromSerializableMap(
  ...
  @override
  String toString() => 'DtOrderSuspendedReasonStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is DtOrderSuspendedReasonStruct &&
        id == other.id &&
...
DtOrderSuspendedReasonStruct createDtOrderSuspendedReasonStruct({
  int? id,
  int? departmentId,
  String? description,
  bool? isAvailable,
