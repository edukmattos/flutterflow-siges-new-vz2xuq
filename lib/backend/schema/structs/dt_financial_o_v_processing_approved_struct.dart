...
class DtFinancialOVProcessingApprovedStruct extends BaseStruct {
  ...
  static DtFinancialOVProcessingApprovedStruct fromMap(
  ...
  static DtFinancialOVProcessingApprovedStruct? maybeFromMap(dynamic data) =>
      data is Map
          ? DtFinancialOVProcessingApprovedStruct.fromMap(
  ...
  static DtFinancialOVProcessingApprovedStruct fromSerializableMap(
          Map<String, dynamic> data) =>
      DtFinancialOVProcessingApprovedStruct(
  ...
  @override
  String toString() => 'DtFinancialOVProcessingApprovedStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is DtFinancialOVProcessingApprovedStruct &&
...
DtFinancialOVProcessingApprovedStruct
    createDtFinancialOVProcessingApprovedStruct({
  double? servicesValue,
  double? materialsValue,
  double? vehiclesValue,
  double? totalValue,
