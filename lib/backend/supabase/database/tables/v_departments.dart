...
class VDepartmentsTable extends SupabaseTable<VDepartmentsRow> {
  @override
  String get tableName => 'v_departments';

  @override
  VDepartmentsRow createRow(Map<String, dynamic> data) => VDepartmentsRow(data);
}

class VDepartmentsRow extends SupabaseDataRow {
  VDepartmentsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VDepartmentsTable();
