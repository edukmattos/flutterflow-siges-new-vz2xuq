...
class VOrdersVisitsExtrasTable extends SupabaseTable<VOrdersVisitsExtrasRow> {
  @override
  String get tableName => 'v_orders_visits_extras';

  @override
  VOrdersVisitsExtrasRow createRow(Map<String, dynamic> data) =>
      VOrdersVisitsExtrasRow(data);
}

class VOrdersVisitsExtrasRow extends SupabaseDataRow {
  VOrdersVisitsExtrasRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VOrdersVisitsExtrasTable();
