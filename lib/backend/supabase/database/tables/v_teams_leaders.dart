...
class VTeamsLeadersTable extends SupabaseTable<VTeamsLeadersRow> {
  @override
  String get tableName => 'v_teams_leaders';

  @override
  VTeamsLeadersRow createRow(Map<String, dynamic> data) =>
      VTeamsLeadersRow(data);
}

class VTeamsLeadersRow extends SupabaseDataRow {
  VTeamsLeadersRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VTeamsLeadersTable();
