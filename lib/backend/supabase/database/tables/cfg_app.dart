...
class CfgAppTable extends SupabaseTable<CfgAppRow> {
  @override
  String get tableName => 'cfg_app';

  @override
  CfgAppRow createRow(Map<String, dynamic> data) => CfgAppRow(data);
}

class CfgAppRow extends SupabaseDataRow {
  CfgAppRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => CfgAppTable();
