...
class CfgTeamsTable extends SupabaseTable<CfgTeamsRow> {
  @override
  String get tableName => 'cfg_teams';

  @override
  CfgTeamsRow createRow(Map<String, dynamic> data) => CfgTeamsRow(data);
}

class CfgTeamsRow extends SupabaseDataRow {
  CfgTeamsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => CfgTeamsTable();
