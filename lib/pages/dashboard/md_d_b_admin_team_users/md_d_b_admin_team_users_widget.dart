...
class MdDBAdminTeamUsersWidget extends StatefulWidget {
  const MdDBAdminTeamUsersWidget({super.key});
                                                ...
                                                return Row(
                                                  ...
                                                  children: [
                                                    CpUserPicProfileWidget(
                                                      key: Key(
                                                          'Keyl5i_${gcTeamUsersIndex}_of_${gcTeamUsers.length}'),
                                                      cpSize: 50,
                                                      imgUrl:
                                                          '${FFAppState().stAppServerUrlDbStorage}${gcTeamUsersItem.imgFilePath}${gcTeamUsersItem.imgFileName}',
                                                      toolTip: gcTeamUsersItem
                                                          .nameShort,
                                                      isAvailable:
                                                          gcTeamUsersItem
                                                              .isAvailable,
