...
import 'md_d_b_admin_filters_services_model.dart';
export 'md_d_b_admin_filters_services_model.dart';

class MdDBAdminFiltersServicesWidget extends StatefulWidget {
  const MdDBAdminFiltersServicesWidget({
    super.key,
    String? cpEntity,
  ...
  @override
  State<MdDBAdminFiltersServicesWidget> createState() =>
      _MdDBAdminFiltersServicesWidgetState();
}

class _MdDBAdminFiltersServicesWidgetState
    extends State<MdDBAdminFiltersServicesWidget> {
  late MdDBAdminFiltersServicesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MdDBAdminFiltersServicesModel());
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        ...
                                                        safeSetState(() {
                                                          _model
                                                              .cpDropdownFiltersOObjectsModel
                                                              .dropdownFiltersOObjectsValueController
                                                              ?.value = [];
                                                        });
                                                        safeSetState(() {
                                                          _model
                                                              .cpDdOTypesSubsMultiAllModel
                                                              .ddOTypesSubsMultiAllValueController
                                                              ?.value = [];
                                                        });
                                                        safeSetState(() {
                                                          _model
                                                        ...
                                                        safeSetState(() {
                                                          _model
                                                              .cpDropdownFiltersContractsDepartmentProvidersModel
                                                              .dropdownFiltersContractsDepartmentProvidersValueController
                                                              ?.value = [];
                                                        });
                                                        safeSetState(() {
                                                          _model
                                                              .cpDropdownFiltersOPlansDepartmentModel
                                                              .dropdownFiltersOPlansDepartmentValueController
                                                              ?.value = [];
                                                        });
                                                        safeSetState(() {
                                                          _model
                                                    ...
                                                    if (FFAppState()
                                                      ...
                                                      FFAppState()
                                                        ...
                                                        (e) => e
                                                          ..contracts = _model
                                                              .cpDropdownFiltersContractsDepartmentModel
                                                              .dropdownFiltersContractsDepartmentValue!
                                                              .toList(),
                                                      );
                                                      FFAppState()
                                                          .update(() {});
                                                      ...
                                                      FFAppState()
                                                        ...
                                                        (e) => e
                                                          ..contracts = _model
                                                              .cpDropdownFiltersContractsDepartmentProvidersModel
                                                              .dropdownFiltersContractsDepartmentProvidersValue!
                                                              .toList(),
                                                      );
                                                      FFAppState()
                                                          .update(() {});
                                                      ...
                                                      await action_blocks
                                                        ...
                                                        abUnitsTypesParent:
                                                            FFAppState()
                                                                .stFiltersServices
                                                                .unitsTypesParent,
                                                        abUnitsTypes: FFAppState()
                                                            .stFiltersServices
                                                            .unitsTypes,
                                                        abAssetsTags: FFAppState()
                                                            .stFiltersServices
                                                            .assetsTags,
                                                        abOTypes: FFAppState()
                                                            .stFiltersServices
