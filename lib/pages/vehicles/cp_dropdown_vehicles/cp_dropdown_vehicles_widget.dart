  ...
  Widget build(BuildContext context) {
    ...
    return FlutterFlowDropDown<int>(
      controller: _model.dropdownVehiclesValueController ??=
        ...
        _model.dropdownVehiclesValue ??= widget.cpInitialValue,
      ),
      options: List<int>.from(
          FFAppState().stOfflineVehicles.map((e) => e.id).toList()),
      optionLabels:
          FFAppState().stOfflineVehicles.map((e) => e.plates).toList(),
      onChanged: (val) =>
          safeSetState(() => _model.dropdownVehiclesValue = val),
