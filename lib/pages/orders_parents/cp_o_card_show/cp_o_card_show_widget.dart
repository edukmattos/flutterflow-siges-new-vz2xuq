        ...
        child: Column(
          ...
          children: [
                    ...
                    children: [
                        ...
                        children: [
                            ...
                            children: [
                              wrapWithModel(
                                ...
                                child: CpOPButtonWidget(
                                  cpOPId: widget.cpODt!.parentId,
                                  cpOMask: widget.cpODt!.orderMask,
                                  cpIsRedirect: false,
                                ),
                              ),
                              Text(
                          ...
                          wrapWithModel(
                            ...
                            child: CpOPriorityWidget(
                              cpOPriorityId: widget.cpODt!.priorityId,
                              cpOPriorityDscription:
                                  widget.cpODt!.priorityDescription,
                            ),
                          ),
                        ],
                      ),
                      wrapWithModel(
                        ...
                        child: CpCompanyLogoWidget(
                          cpSize: 60,
                          cpImgUrl:
                              '${FFAppState().stAppServerUrlDbStorage}${widget.cpODt?.imgFilePath}${widget.cpODt?.imgFileName}',
                        ),
                      ),
                    ],
                  ),
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            await action_blocks.abUnitSelected(
                              context,
                              abUnitId: widget.cpODt?.unitId,
                            );

                            context.pushNamed(PgUnitShowWidget.routeName);
                          },
                          child: Text(
            ...
            Row(
              ...
              children: [
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              valueOrDefault<String>(
                                widget.cpODt?.suspendedReasonDescription,
                                'Cancelamento',
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .titleSmall
                ...
                ToggleIcon(
                  onPressed: () async {
                    safeSetState(() =>
                        _model.lcsvDetailsRequest = !_model.lcsvDetailsRequest);
                  },
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            valueOrDefault<String>(
                              widget.cpODt?.companyDescription,
                              'Empresa',
                            ),
                            style: FlutterFlowTheme.of(context)
                                .titleSmall
            ...
            Row(
              ...
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                if ((FFAppState().stUserCurrent.ovIdInProgress == 0) &&
                    (widget.cpODt?.teamLeaderId ==
