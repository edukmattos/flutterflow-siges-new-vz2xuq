...
import 'md_o_change_team_widget.dart' show MdOChangeTeamWidget;
import 'package:flutter/material.dart';

class MdOChangeTeamModel extends FlutterFlowModel<MdOChangeTeamWidget> {
  ///  State fields for stateful widgets in this component.

  final formKey = GlobalKey<FormState>();
  // Stores action output result for [Backend Call - API (apiUsersByTeamId)] action in orderParentNew widget.
  ApiCallResponse? apiResult1vl;
