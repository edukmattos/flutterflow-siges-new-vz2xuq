...
import 'pg_o_create_model.dart';
export 'pg_o_create_model.dart';

class PgOCreateWidget extends StatefulWidget {
  const PgOCreateWidget({
    super.key,
  ...
  static String routeName = 'pgOCreate';
  static String routePath = 'pgOCreate';

  @override
  State<PgOCreateWidget> createState() => _PgOCreateWidgetState();
}

class _PgOCreateWidgetState extends State<PgOCreateWidget> {
  late PgOCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgOCreateModel());
