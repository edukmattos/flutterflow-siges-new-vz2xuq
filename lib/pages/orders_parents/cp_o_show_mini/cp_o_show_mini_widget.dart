...
class CpOShowMiniWidget extends StatefulWidget {
  const CpOShowMiniWidget({
    super.key,
    required this.cpODt,
  });
  ...
  @override
  State<CpOShowMiniWidget> createState() => _CpOShowMiniWidgetState();
}

class _CpOShowMiniWidgetState extends State<CpOShowMiniWidget>
    with TickerProviderStateMixin {
  late CpOShowMiniModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpOShowMiniModel());
