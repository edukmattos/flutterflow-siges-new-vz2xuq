...
import 'cp_o_v_asset_material_shop_list_item_model.dart';
export 'cp_o_v_asset_material_shop_list_item_model.dart';

class CpOVAssetMaterialShopListItemWidget extends StatefulWidget {
  const CpOVAssetMaterialShopListItemWidget({
    super.key,
  ...
  @override
  State<CpOVAssetMaterialShopListItemWidget> createState() =>
      _CpOVAssetMaterialShopListItemWidgetState();
}

class _CpOVAssetMaterialShopListItemWidgetState
    extends State<CpOVAssetMaterialShopListItemWidget>
    with TickerProviderStateMixin {
  late CpOVAssetMaterialShopListItemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpOVAssetMaterialShopListItemModel());
                                ...
                                await OrdersVisitsAssetsMaterialsTable()
                                  ...
                                  'value_total': functions
                                          .cfConvNumberStringToDouble(_model
                                              ...
                                              .textController
                                              .text) *
                                      functions.cfConvNumberStringToDouble(
                                          _model.cpInputADModel.textController
                                              .text) *
                                      functions.cfConvNumberStringToDouble(
                                          _model.cpInputAmountModel
                                              .textController.text),
                                  'ova_id': FFAppState().stOVSelectedAsset.id,
                                });
