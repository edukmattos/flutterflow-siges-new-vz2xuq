...
import 'pg_asset_c_u_step031_model.dart';
export 'pg_asset_c_u_step031_model.dart';

class PgAssetCUStep031Widget extends StatefulWidget {
  const PgAssetCUStep031Widget({
    super.key,
  ...
  static String routeName = 'pgAssetCUStep_03_1';
  static String routePath = 'pgAssetCUStep031';

  @override
  State<PgAssetCUStep031Widget> createState() => _PgAssetCUStep031WidgetState();
}

class _PgAssetCUStep031WidgetState extends State<PgAssetCUStep031Widget>
    with TickerProviderStateMixin {
  late PgAssetCUStep031Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgAssetCUStep031Model());
                                            ...
                                            TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                labelText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  '1gcwt1rc' /* Correntes eléticas (A1/A2) */,
                                                ),
                                                labelStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyLarge
