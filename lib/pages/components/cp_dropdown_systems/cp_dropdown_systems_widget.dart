  ...
  Widget build(BuildContext context) {
    ...
    return FlutterFlowDropDown<int>(
      controller: _model.dropdownSystemsValueController ??=
        ...
        _model.dropdownSystemsValue ??= widget.cpInitialValue,
      ),
      options: List<int>.from(
          FFAppState().stOfflineSystems.map((e) => e.id).toList()),
      optionLabels:
          FFAppState().stOfflineSystems.map((e) => e.description).toList(),
      onChanged: (val) => safeSetState(() => _model.dropdownSystemsValue = val),
