...
import 'pg_unit_create_model.dart';
export 'pg_unit_create_model.dart';

class PgUnitCreateWidget extends StatefulWidget {
  const PgUnitCreateWidget({super.key});

  static String routeName = 'pgUnitCreate';
  static String routePath = 'pgUnitCreate';

  @override
  State<PgUnitCreateWidget> createState() => _PgUnitCreateWidgetState();
}

class _PgUnitCreateWidgetState extends State<PgUnitCreateWidget> {
  late PgUnitCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgUnitCreateModel());
                  ...
                  child: Align(
                    ...
                    child: wrapWithModel(
                      ...
                      child: CpDBUserAvailableWidget(
                        toolTip: FFAppState().stUserCurrent.id.toString(),
                      ),
                    ),
                  ),
                ),
