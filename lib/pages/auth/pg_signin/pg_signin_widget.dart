...
class PgSigninWidget extends StatefulWidget {
  ...
  static String routeName = 'pgSignin';
  static String routePath = 'pgSignin';
...
class _PgSigninWidgetState extends State<PgSigninWidget> {
  ...
  void initState() {
    ...
    _model.switchValue =
        FFAppState().stAppVersionMode == EnumVersionsMode.live ? true : false;
                                      ...
                                      children: [
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '2lbtaner' /* Preencha os campos abaixo para... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    final user =
                                                        await authManager
                                                            .signInWithEmail(
                                                      context,
                                                      '${functions.cfInputTrim(_model.tfUserNameTextController.text)}${FFAppState().stCompanySelected.emailSufix}',
                                                      _model
                                                          .tfPasswordTextController
                                                          .text,
                                                    );
                                                          ...
                                                          builder:
                                                            ...
                                                            return AlertDialog(
                                                              title: Text(
                                                                  'Ops ... '),
                                                              content: Text(
                                                                  'Sua conta encontra-se em ANÁLISE. Favor aguardar.'),
                                                              actions: [
                                                                TextButton(
                                                                  onPressed: () =>
                                                                      Navigator.pop(
                                                            ...
                                                            builder:
                                                              ...
                                                              return AlertDialog(
                                                                title: Text(
                                                                    'Ops ... '),
                                                                content: Text(
                                                                    'Sua conta encontra-se em INATIVA.'),
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () =>
                                                                        Navigator.pop(
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              context.pushNamed(
                                                  PgPasswordRecoveryWidget
                                                      .routeName);
                                            },
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              'xdwdg0ou' /* Esqueceu a senha ? */,
                                            ),
                                            options: FFButtonOptions(
                                              width: double.infinity,
                                              height: 54.0,
