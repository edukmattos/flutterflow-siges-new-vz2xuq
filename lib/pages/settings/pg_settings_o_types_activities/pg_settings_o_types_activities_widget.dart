...
import 'pg_settings_o_types_activities_model.dart';
export 'pg_settings_o_types_activities_model.dart';

class PgSettingsOTypesActivitiesWidget extends StatefulWidget {
  const PgSettingsOTypesActivitiesWidget({super.key});

  static String routeName = 'pgSettingsOTypesActivities';
  static String routePath = 'pgSettingsOTypesActivities';

  @override
  State<PgSettingsOTypesActivitiesWidget> createState() =>
      _PgSettingsOTypesActivitiesWidgetState();
}

class _PgSettingsOTypesActivitiesWidgetState
    extends State<PgSettingsOTypesActivitiesWidget> {
  late PgSettingsOTypesActivitiesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgSettingsOTypesActivitiesModel());
