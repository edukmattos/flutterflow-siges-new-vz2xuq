...
class CpTMAssetListItemWidget extends StatefulWidget {
  const CpTMAssetListItemWidget({
    super.key,
  ...
  @override
  State<CpTMAssetListItemWidget> createState() =>
      _CpTMAssetListItemWidgetState();
}

class _CpTMAssetListItemWidgetState extends State<CpTMAssetListItemWidget>
    with TickerProviderStateMixin {
  late CpTMAssetListItemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpTMAssetListItemModel());
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Container(
                                  child: wrapWithModel(
                                    model: _model.cpTMAssetFollowingModel,
                                    updateCallback: () => safeSetState(() {}),
                                    child: CpTMAssetFollowingWidget(
                    ...
                    children: [
                      ...
                      Text(
                        valueOrDefault<String>(
                          dateTimeFormat(
                            "dd/MM/y",
                            widget.cpAssetDt?.acquisitionDatetime,
